...
def get_dataset_and_loader(args, trans_list, only_test=False):
    # For these arguments, I used the default values provided in the args parser of STG
    loader_args = {'batch_size': 256, 'num_workers': 8, 'pin_memory': True}
    dataset_args = {'dataset': args.dataset,
                    'headless': False, 'scale': 0, 'scale_proportional': 1,
                    'seg_len': 24, 'return_indices': True, 'return_metadata': True,
                    'train_seg_conf_th': 0.0, 'specific_clip': None}

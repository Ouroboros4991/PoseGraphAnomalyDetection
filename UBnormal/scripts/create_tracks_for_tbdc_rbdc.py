"""This script creates the bounding boxes of abnormal events for UBnormal
"""
import cv2 as cv
import numpy as np
import os
...
if __name__ == '__main__':
    for data_type in ["training", "validation", "test"]:
        ...
        base_input_folder = "/mnt/c/Users/ruben/Downloads/UBnormal_data"
        # path to the output folder
        output_folder = f"/mnt/d/VUB/CurrentTrendsOfAI/PoseGraphAnomalyDetection/UBnormal/data/bounding_boxes/{data_type}"
        os.makedirs(output_folder, exist_ok=True)
        # paths to the video names
        abnormal_video_names_path = f"abnormal_{data_type}_video_names.txt"
        normal_video_names_path = f"normal_{data_type}_video_names.txt"
